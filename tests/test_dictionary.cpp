...
inline void test_adds_entries_with_one_argument() {
	{
		translate_function_t *func = [](TRANSLATE_FUNCTION_ARGS) {};
	...
	{
		translate_function_t *func1 = [](TRANSLATE_FUNCTION_ARGS) {};
		translate_function_t *func2 = [](TRANSLATE_FUNCTION_ARGS) {};
		dictionary_t dictionary;
...
inline void test_adds_entries_with_multiple_arguments() {
	{
		translate_function_t *func1 = [](TRANSLATE_FUNCTION_ARGS) {};
		translate_function_t *func2 = [](TRANSLATE_FUNCTION_ARGS) {};
		translate_function_t *func3 = [](TRANSLATE_FUNCTION_ARGS) {};
		dictionary_t dictionary;
